...
- **::gamepad:: 游戏模式**：选填，需要绑定的 ::gamepad:: 游戏模式。可输入：
  ...
  - osu relax / 0rx / 4：::circle-dot:: 主模式 (Relax 模组)，osu!standard，osu!std
  - taiko relax / 1rx / 5：::drum:: 太鼓模式 (Relax 模组)，osu!taiko
  - catch relax / fruits relax / 2rx / 6：::apple-whole:: 接水果模式 (Relax 模组)，osu!catch
  - osu autopilot / ap / 8：::circle-dot:: 主模式 (Autopilot 模组)，osu!standard，osu!std
...
## ::circle-info:: 2 查询玩家信息 ?yminfo (?i) {id=info}
